                ...
                if(type === 'accept'){
                    if(+this.myDetails.valu > +this.myDetails.wallet_cap){
                        const alert = await this.alertCtrl.create({
                            ...
                            message: `Your wallet has ${this.myDetails.wallet_cap} (vs ${this.myDetails.valu}) in ${this.myDetails.wallet_dba} Valu.<br/><br/>Please contact your parter to resolve the issue.`,
                            buttons: [{
                                text: 'OK',
                                role: 'cancel',
                                handler: () => {
                    ...
                    if(+this.details.valu > +this.details.wallet_cap){
                        const alert = await this.alertCtrl.create({
                            ...
                            message: `Your partner has ${this.details.wallet_cap} (vs. ${this.details.valu}) in ${this.details.wallet_dba} Valu.<br/><br/>Please contact your parter to resolve the issue.`,
                            buttons: [{
                                text: 'OK',
                                role: 'cancel',
                                handler: () => {
